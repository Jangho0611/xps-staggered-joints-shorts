...
registerRoot(()=> <>
 <Composition id="XpsCoverAstraV2" component={Cover} durationInFrames={1} fps={30} width={1080} height={1920}/>
 <Composition id="XpsCoverAstraV2Square" component={Square} durationInFrames={1} fps={30} width={1080} height={1080}/>
</>);
