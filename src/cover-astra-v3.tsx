...
const PointRight=()=>{
 ...
 return src?<Img src={src} style={{position:'absolute',left:0,top:1080,width:320,height:'auto'}}/>:null;
};
...
const Cover=()=> <AbsoluteFill style={{fontFamily:PRETENDARD,background:'#BDC1C7',overflow:'hidden'}}>
 {/* Full 1080x1920 scene: 1:1, no crop, scale, translation or filtering.
     The wall returns, floor junction and gun retain original coordinates. */}
 <Img src={staticFile('covers/source/scene03-cover-hero-candidate-2.png')} style={{position:'absolute',left:0,top:0,width:1080,height:1920}}/>
 {/* Cover header underlay: only the scene text area, above the wall at y570.
     Its color is the original scene canvas, so this adds no new design. */}
 <div style={{position:'absolute',left:80,top:190,width:700,height:315,background:'#EEEDE8'}}/>
 {/* Only the small footer lettering; the wall/floor geometry stays in place. */}
 <div style={{position:'absolute',left:84,top:1580,width:470,height:32,background:'#D6D4CD'}}/>
 <div style={{position:'absolute',left:53,top:341,width:717,height:353,borderRadius:36,background:'#F5E9D4',border:'1px solid #e3e8ee',boxSizing:'border-box'}}/>
...
registerRoot(()=> <>
 <Composition id="XpsCoverAstraV3" component={Cover} durationInFrames={1} fps={30} width={1080} height={1920}/>
 <Composition id="XpsCoverAstraV3Square" component={Square} durationInFrames={1} fps={30} width={1080} height={1080}/>
</>);
